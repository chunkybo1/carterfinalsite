...
export const JurisdictionBar = () => {
  return (
    <div className="w-full bg-navy/50 border-y border-white/5 py-6">
      <Container>
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-16 opacity-60">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
            ...
            <div className="hidden md:block w-1.5 h-1.5 rounded-full bg-bronze/50" />
