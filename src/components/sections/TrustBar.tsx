...
export const TrustBar = () => {
  return (
    <section className="relative w-full bg-gradient-to-b from-[#050b14] to-[#0a1525] py-20 lg:py-32 overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-10 items-center">
          ...
          >
            {/* Video Background (Glass Effect) */}
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-md z-10 transition-colors group-hover:bg-white/10" />
